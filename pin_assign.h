...
// This are ther pins used the STM Nucleo STM32F4xx boards and the 
// Motor Sheild.  See pinout diagram at 
...
#define ENC1A   PC11   //      Motor 2 Phase A  
#define ENC1B   PD2    //      Motor 2 Phase B  
//
//
// Pin locations onk,,,,kkkjjllliiiik CN7.  Note there is a "dot" printed nere pin #1
